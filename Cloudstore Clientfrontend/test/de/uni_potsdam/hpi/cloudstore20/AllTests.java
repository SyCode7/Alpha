...
import de.uni_potsdam.hpi.cloudstore20.clientfrontend.StorageProviderTests;
import de.uni_potsdam.hpi.cloudstore20.meta.MetaTests;

@RunWith(Suite.class)
@SuiteClasses({ MetaTests.class, DataProcessingTests.class, HelperTests.class, StorageProviderTests.class })
