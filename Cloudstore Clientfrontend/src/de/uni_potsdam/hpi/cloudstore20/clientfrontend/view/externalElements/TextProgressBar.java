 ...
 *******************************************************************************/
package de.uni_potsdam.hpi.cloudstore20.clientfrontend.view.externalElements;
...
/**
 * Instances of the receiver represent an unselectable user interface object that is used to display progress, typically in the
 * form of a bar. A text that represent the percentage of selected value is displayed on the widget.
 * <dl>
 * <dt><b>Styles:</b></dt>
