...
import de.uni_potsdam.hpi.cloudstore.log.Logger.Method;
...
public abstract class BaseEntry {
	...
	public void set_type(int k, int m, Method method, String action) {
	...
	public String toString() {
		...
		return this.id + BaseEntry.DELIMITER + this.timestamp + BaseEntry.DELIMITER + this.getType() + dynamicLog;
	}
